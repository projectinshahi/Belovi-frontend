...
export function ToastProvider({ children }: { children: React.ReactNode }) {
  ...
  const getStyles = (type: ToastType) => {
    switch (type) {
      ...
      default:
        // Tailwind's own `sky` scale, like the three above. This used to be
        // `blue-*`, which globals.css remapped to near-black surfaces and a
        // dark maroon text — the info toast rendered unreadable.
